...
class RenderCommandsTestCase(TestCase):
    ...
    def test_command__makes_the_right_calls(self):
        ...
        self.mocker.patch(
            'lily.entrypoint.management.commands.render_commands.get_version'
        ).return_value = '8.9.1'
        self.mocker.patch(
            'lily.entrypoint.management.commands.render_commands.get_lily_path'
        ).return_value = str(self.lily_dir)
