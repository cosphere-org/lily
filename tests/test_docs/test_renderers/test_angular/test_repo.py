...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('0.1.11', Repo.VERSION_UPGRADE.MINOR, '0.2.11'),

        # -- minor version upgrade - triangulation
        ('6.14.23', Repo.VERSION_UPGRADE.MINOR, '6.15.23'),

        # -- major version upgrade
        ('0.1.11', Repo.VERSION_UPGRADE.MAJOR, '1.1.11'),

        # -- major version upgrade - triangulation
        ('6.14.23', Repo.VERSION_UPGRADE.MAJOR, '7.14.23'),
    ])
